...
P5 = np.array([1, 0.25, 1])

#PL_5 = np.matmul(TL_5,P5)

P4 = np.array([0.01*np.cos(theta4), 0.025*np.sin(theta4), 1])

TL_5_2 = np.matmul(np.matmul(np.matmul(np.matmul(TL_1,T1_2),T2_3),T3_4),T4_5)

PL_5 = np.matmul(np.matmul(np.matmul(np.matmul(np.matmul(TL_1,T1_2),T2_3),T3_4),T4_5),P4)
