...
parser.add_argument('--s_theta', type=float,default=0.1, help="Standard Deviation Theta")

args = parser.parse_args()

# Define uncertainties associated to joints and links

mean_a1, std_a1 = args.a[0], args.s_a
mean_theta1, std_theta1 = args.theta[0], args.s_theta
mean_a2, std_a2 = args.a[1], args.s_a
mean_theta2, std_theta2 = args.theta[1], args.s_theta
